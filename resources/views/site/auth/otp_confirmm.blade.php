        ...
        <div class="row">
          ...
          <div class="mb-3">
            ...
            <input type="submit"  class="btn btn-primary border-0 rounded-0 w-100" value="  {{__('Sign In')}} " style="background-color: var(--main-color);">
                    ...
                    <div class="mb-3">
                        <label for="user-name-or-email" class="form-label"> {{ __('OTP') }}</label>

                        @error('phone')
                            <small class="form-text text-danger">{{ __('The password or email does not match our records.') }}
                            </small>
                        @enderror
                        <input type="text" name="phone" value="{{ old('phone') }}" class="form-control"
                            id="user-name-or-email" placeholder="xxxxxxxxxxxxxx">

                    </div>
                    <input type="submit" class="btn btn-sqr text-light w-100" value="{{ __('Sign In') }} "
